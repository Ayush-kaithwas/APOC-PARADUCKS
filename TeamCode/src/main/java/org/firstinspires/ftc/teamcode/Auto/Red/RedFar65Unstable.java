...
import static org.firstinspires.ftc.teamcode.Auto.Blue.BlueFar65Unstabble.ThresholdColor;
import static org.firstinspires.ftc.teamcode.Auto.Blue.BlueFar65Unstabble.ThresholdDistance;
...
@Autonomous
@Config
public class RedFar65Unstable extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence center = drive.trajectorySequenceBuilder(startPose)
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.6, ()-> Intake.rollOutside(0.7))
...
// TODO ================================================================= TODO FIRST CYCLE START FOR WHITE PIXEL ========================================================
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.8, ()-> Intake.rollOutside(0.6))
                ...
                .UNSTABLE_addTemporalMarkerOffset(-0.6, ()-> Intake.rollOutside(0.8))
...
//                .UNSTABLE_addTemporalMarkerOffset(-()-> Intake.setIntakeServo(Globals.stackInit))
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(startPose)
                ...
                // todo going for purple pixel
                .lineToLinearHeading(new Pose2d(-52, -40, Math.toRadians(240)))
                // TODO DROPPING THE PURPLE PIXEL
                ...
                .lineToLinearHeading(new Pose2d(-54, -40, Math.toRadians(225)))

...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(9.25,0.004, 0.7);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(8.5, 0.005, 0.007);
...
//            robotHeading = Math.toRadians(angle.firstAngle);
    ...
    public List<Double> getMotorCurrent() {
        ...
        double rightRearCurrent = rightRear.getCurrent(CurrentUnit.AMPS);
        double leftRearCurrent = leftRear.getCurrent(CurrentUnit.AMPS);

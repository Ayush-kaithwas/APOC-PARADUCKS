...
public class PropPipeline implements VisionProcessor {
    ...
    //TODO RED FAR
    public static int redFarLeftX = 350; //(int) (815 / 1.5);
    public static int redFarLeftY = 420; //(int) (550 / 1.5);
    public static int redFarCenterX = 570;//580; //(int) (1365 / 1.5);
    public static int redFarCenterY = 430; //(int) (475 / 1.5);

    //TODO BLUE FAR
    //LEFT
    public static int blueFarLeftX = 200;//120; //(int) (240 / 1.5);
    public static int blueFarLeftY = 420; //(int) (525 / 1.5);
    //CENTER
    public static int blueFarCenterX = 540;//500;
    public static int blueFarCenterY = 410;

    //TODO RED NEAR
    public static int redNearLeftX = 140;//90; //(int) (815 / 1.5);
    public static int redNearLeftY = 420; //(int) (550 / 1.5);
    public static int redNearCenterX = 470; //(int) (1365 / 1.5);
    public static int redNearCenterY = 440; //(int) (475 / 1.5);

    //TODO BLUE NEAR
    public static int blueNearLeftX = 340;//380; //(int) (240 / 1.5);
    public static int blueNearLeftY = 420; //(int) (525 / 1.5);
    public static int blueNearCenterX = 620;
    public static int blueNearCenterY = 400;



    ///////////////////////////////////////////////////////////////////
    public static int leftWidth =170; //(int) (175 / 1.5);
    public static int leftHeight = 150; //(int) (100 / 1.5);
    /////////////////////////////////////////////////
    public static int centerWidth = 200; //(int) (125 / 1.5);
    public static int centerHeight = 90; //(int) (125 / 1.5);
    /////////////////////////////////////////////////
    public static double BLUE_TRESHOLD = 100;
    public static double RED_TRESHOLD = 100; //(int) (125 / 1.5);
